...
<form id="select" method="POST" action="gabbracoladm.php?q=1">
...
Durante a maior parte do período colonial a participação nas câmaras das vilas era uma prerrogativa dos chamados "homens bons", excluindo-se desse privilégio os outros integrantes da sociedade. A expressão "homem bom" dizia respeito a: <br><Br>
  ...
  <form id="select" method="post" action="gabbracoladm.php?q=2">
            <br>
        <div>
...
<br><Br>
  ...
  <form id="select" method="post" action="gabbracoladm.php?q=3">
          <br>  
        <div>
...
Com base no texto, é possível afirmar que o autor se refere:
  ...
  <form id="select" method="post" action="gabbracoladm.php?q=4">
            <br>
        <div>
...
<Br><br>
  ...
  <form id="select" method="post" action="gabbracoladm.php?q=5">
            <br>
        <div>
