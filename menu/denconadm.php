...
?>
    ...
    <title>Denotação e Conotação</title>
...
<div class="conteudoos">
  <h2>DENOTAÇAO E CONOTAÇÃO</h2>
        ...
        <div>
          ...
          <font face="Anson"><font size="4" color="black"><B>CONOTAÇÂO</B><BR>
A linguagem conotativa é utilizada quando o significado de uma palavra, frase ou texto é empregado de forma figurada, circunstancial, ou seja, não carrega, naquele contexto, o seu sentido comum. Seja em anúncios, expressões ou ditados populares, poesias, literatura e músicas, a conotação está sempre presente.<BR>
Exemplo:<BR>
Ele é o laranja da empresa. (Indivíduo envolvido em transações ilícitas)<BR>
Seu sucesso é enorme, já pode ser considerada uma estrela. (Pessoa que se destaca tanto quanto uma estrela na escuridão do céu)<BR>
Não vou com vocês nem que a vaca tussa. (Expressão que reforça uma negação)<BR>
<BR>
<b>Denotação<BR></B>
 É usada para informar de forma objetiva, direta e clara. Exemplos de lugares onde podemos encontrar a linguagem empregada denotativamente são os textos científicos, jornalísticos e instrutivos.<BR>
Eu odeio suco de laranja. (Fruta)<BR>
Minha camisa é laranja. (Cor)<BR>
<Br>
<B>Bizu: </B><br>
Denotação, é o sentido da palavra real, do dicionário. O bizu é: DEnotação. Lembre-se que esse DE, vem de Deus. Deus é uma pessoa que simboliza algo correto, do certo. Logo, DE(us)NOTAÇÃO. É a linguagem de Deus. Logo, se denotação é a linguagem correta, conotação só pode ser a linguagem do sntido figurado.

<br><br>
<img src="./imagens/decon.jpg" width="40%" class="exemplor"> 
<br>
Fonte: <a href="https://www.gramatica.net.br/denotacao-e-conotacao/" target="_blank">https://www.gramatica.net.br/denotacao-e-conotacao/</a><br>

          </div>
          <br>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/PqetqnKNzLc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" class="videopt" allowfullscreen> </iframe> </div> </div>
      ...
      <br><br><br><br>
          ...
          <button class="button button1" onclick="window.location.href='./exerciciodenconadm.php'"><div style="text-decoration: none;"><font color="white">Exercicios</div>
            </font></button>
