  ...
  <h2>História</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./regimeadm.php'"><div style="text-decoration: none;"><font color="white">Regime Militar</button></font></div><br>
            <button class="button button1" onclick="window.location.href='./eravadm.php'"><div style="text-decoration: none;"><font color="white">Era Vargas</font></div></button><br><br>
            <button class="button button1" onclick="window.location.href='./bracoladm.php'"><div style="text-decoration: none;"><font color="white">Brasil Colônia</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./revindadm.php'"><div style="text-decoration: none;"><font color="white">Revolução Industrial</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./segmundadm.php'"><div style="text-decoration: none;"><font color="white">Segunda Guerra Mundial</button></font></div><br><br></font></font>
</div>
</div>
</ul>
