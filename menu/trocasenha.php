...
<form action="../visitante/senhanova.php" method="post">
...
<div id='busca'>
          ...
          <input oninput="mascara(this)" type="text" onKeyDown='blockKeyCTRL(event);' oncontextmenu="return false" onkeypress="return soNum(event);"  class="txtbusca" name="cpf" placeholder="Digite seu CPF" onkeyup="this.value=this.value.replace(/[' ']/g,'')" ondragstart="return false" onselectstart="return false" onpaste="return false" autocomplete="off" size="32" required> 
<br><br>
          <input type="password" id="nsenha" class="txtbusca" onKeyDown='blockKeyCTRL(event);' oncontextmenu="return false" onkeypress="return soNum(event);"  name="nsenha" placeholder="Digite sua nova senha desejada" onkeyup="this.value=this.value.replace(/[' ']/g,'')" ondragstart="return false" onselectstart="return false" onpaste="return false" autocomplete="off" size="32" required> 
