...
<div class="conteudoos">
  <h2>As Matérias</h2>
        ...
        <img src="imagens/seno.png" class="materias" align="right">
          ...
          <font face="Arial"><font size="5" color="black" face="Anson">Bom, vamos para a parte que nos interessa. Como<br>ficam as matérias?<br>
   Nosso Portal irá oferecer as seguintes disciplinas<br>(clique em cada uma delas para ver o conteúdo <br>disponível):<br><br>
   <div style="text-decoration: none;"> <button class="button" onclick="window.location.href='./portuadm.php'" style="vertical-align:middle" type="submit" required /><font color="white"><span>Português</div></button></font></span>
   <br>
<div style="text-decoration: none;"> <button class="button" onclick="window.location.href='./matadm.php'" style="vertical-align:middle" type="submit" required /><font color="white"><span>Matemática</div></button></font></span>
<Br>
   <div style="text-decoration: none;"> <button class="button" onclick="window.location.href='./fisadm.php'" style="vertical-align:middle" type="submit"  required /><font color="white"><span>Física</div></button></font></span>
<Br>
<div style="text-decoration: none;"> <button class="button" onclick="window.location.href='./redadm.php'" style="vertical-align:middle" type="submit"  required /><font color="white"><span>Redação</div></button></font></span>
<Br>
<div style="text-decoration: none;"> <button class="button" onclick="window.location.href='./hisadm.php'" style="vertical-align:middle" type="submit"  required /><font color="white"><span>História</div></button></font></span>
<Br>
</font></font>
</div>
</div>
