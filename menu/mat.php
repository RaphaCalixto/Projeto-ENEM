  ...
  <h2>Matemática</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./pratm.php'"><div style="text-decoration: none;"><font color="white">Progressão Aritmética</button></font></div><br>
            <button class="button button1" onclick="window.location.href='./progeo.php'"><div style="text-decoration: none;"><font color="white">Progressão Geométrica</font></div></button><br><br>
            <button class="button button1" onclick="window.location.href='./func1grau.php'"><div style="text-decoration: none;"><font color="white">Função do 1º grau</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./func2grau.php'"><div style="text-decoration: none;"><font color="white">Função do 2º grau</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./analcomb.php'"><div style="text-decoration: none;"><font color="white">Análise Combinatória</button></font></div><br><br></font></font>
</div>
</div>
</ul>
