...
<img src="../imagens/termopa3.jpg" class="videomat" width="30%">
      ...
      <br><br><br><br>
          ...
          <button class="button button1" onclick="window.location.href='./exerciciopratmadm.php'"><div style="text-decoration: none;"><font color="white">Exercicios</div>
            </font></button>
