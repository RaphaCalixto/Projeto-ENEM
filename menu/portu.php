  ...
  <h2>Língua Portuguesa</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./funcl.php'"><div style="text-decoration: none;"><font color="white">Funções da Linguagem</button></font></div><br>
          <button class="button button1" onclick="window.location.href='./ambi.php'"><div style="text-decoration: none;"><font color="white">Ambiguidade</font></div></button><br><br>
          <button class="button button1" onclick="window.location.href='./gentext.php'"><div style="text-decoration: none;"><font color="white">Gêneros textuais</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./figl.php'"> <div style="text-decoration: none;"><font color="white">Figuras de linguagem</font></div></button><br><br>          
<button class="button button1" onclick="window.location.href='./dencon.php'"><div style="text-decoration: none;"><font color="white">Denotação e Conotação</font></div></button><br><br></font></font>
</div>
</div>
</ul>
