...
<form id="select" method="POST" action="gabsegmund.php?q=1">
...
(Fac. Med. Ribeirão Preto-SP) A Segunda Grande Guerra (1939-1945), a partir de 7 de dezembro de 1941, adquire um caráter mundial quando os:<br><Br>
  ...
  <form id="select" method="post" action="gabsegmund.php?q=2">
            <br>
        <div>
...
<br><Br>
  ...
  <form id="select" method="post" action="gabsegmund.php?q=3">
          <br>  
        <div>
...
<Br><br>
  ...
  <form id="select" method="post" action="gabsegmund.php?q=5">
            <br>
        <div>
