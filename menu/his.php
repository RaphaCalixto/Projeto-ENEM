  ...
  <h2>História</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./regime.php'"><div style="text-decoration: none;"><font color="white">Regime Militar</button></font></div><br>
            <button class="button button1" onclick="window.location.href='./erav.php'"><div style="text-decoration: none;"><font color="white">Era Vargas</font></div></button><br><br>
            <button class="button button1" onclick="window.location.href='./bracol.php'"><div style="text-decoration: none;"><font color="white">Brasil Colônia</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./revind.php'"><div style="text-decoration: none;"><font color="white">Revolução Industrial</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./segmund.php'"><div style="text-decoration: none;"><font color="white">Segunda Guerra Mundial</button></font></div><br><br></font></font>
</div>
</div>
</ul>
