...
<form id="select" method="POST" action="gabdencon.php?q=1">
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabdencon.php?q=2">
          <br>  
        <div>
...
<br><br>
  ...
  <form id="select" method="post" action="gabdencon.php?q=3">
          <br>  
        <div>
...
<br><br>
  ...
  <form id="select" method="post" action="gabdencon.php?q=4">
          <br>  
        <div>
