...
<form id="select" method="POST" action="gabopticaadm.php?q=1">
...
É CORRETO afirmar que<br><Br>
  ...
  <form id="select" method="post" action="gabopticaadm.php?q=2">
            <br>
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabopticaadm.php?q=3">
          <br>  
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabopticaadm.php?q=4">
            <br>
        <div>
...
Marque a alternativa que apresenta o nome dado a este evento e o fenômeno óptico envolvido em sua ocorrência.
  ...
  <form id="select" method="post" action="gabopticaadm.php?q=5">
            <br>
        <div>
