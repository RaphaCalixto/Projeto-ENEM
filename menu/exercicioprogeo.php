...
<form id="select" method="POST" action="gabprogeo.php?q=1">
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabprogeo.php?q=2">
            <br>
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabprogeo.php?q=3">
          <br>  
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabprogeo.php?q=4">
            <br>
        <div>
...
<Br><br>
  ...
  <form id="select" method="post" action="gabprogeo.php?q=5">
            <br>
        <div>
