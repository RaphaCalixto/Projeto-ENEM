  ...
  <h2>Física</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./cinem.php'"><div style="text-decoration: none;"><font color="white">Cinemática</button></font></div><br>
            <button class="button button1" onclick="window.location.href='./energia.php'"><div style="text-decoration: none;"><font color="white">Energia</font></div></button><br><br>
            <button class="button button1" onclick="window.location.href='./eletricidade.php'"><div style="text-decoration: none;"><font color="white">Eletricidade</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./termofisica.php'"><div style="text-decoration: none;"><font color="white">TermoFísica</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./optica.php'"><div style="text-decoration: none;"><font color="white">Óptica</button></font></div><br><br></font></font>
</div>
</div>
</ul>
