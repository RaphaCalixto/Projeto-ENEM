...
<br><Br>
      ...
      <br><br><br><br>
          ...
          <button class="button button1" onclick="window.location.href='./exerciciotermofisicaadm.php'"><div style="text-decoration: none;"><font color="white">Exercicios</div>
            </font></button>
