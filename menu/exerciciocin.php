...
<form id="select" method="POST" action="gabcin.php?q=1">
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabcin.php?q=2">
            <br>
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabcin.php?q=3">
          <br>  
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabcin.php?q=4">
            <br>
        <div>
...
<Br><br>
  ...
  <form id="select" method="post" action="gabcin.php?q=5">
            <br>
        <div>
