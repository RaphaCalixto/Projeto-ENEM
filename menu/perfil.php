...
<br><br>
          <input type="password" id="nsenha" class="txtbusca" onKeyDown='blockKeyCTRL(event);' oncontextmenu="return false" onkeypress="return soNum(event);"  name="nsenha" placeholder="Digite sua senha nova" onkeyup="this.value=this.value.replace(/[' ']/g,'')" ondragstart="return false" onselectstart="return false" onpaste="return false" autocomplete="off" size="50" required> 
