...
<form id="select" method="POST" action="gabambi.php?q=1">
...
<br><br>
  <form id="select" method="post" action="gabambi.php?q=2">
          <br>  
        <div>
...
<br><br>
  <form id="select" method="post" action="gabambi.php?q=3">
          <br>  
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabambi.php?q=4">
          <br>  
        <div>
