...
<form id="select" method="POST" action="gabfunc2grauadm.php?q=1">
...
Do ponto de vista econômico, qual equação possibilitaria encontrar a extensão da rodovia que tornaria indiferente para a prefeitura escolher qualquer uma das propostas apresentadas?<br><Br>
  ...
  <form id="select" method="post" action="gabfunc2grauadm.php?q=2">
            <br>
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabfunc2grauadm.php?q=3">
          <br>  
        <div>
...
<div style="text-align:left;justify-content:center; margin-left: 20px;" align="center" >
  ...
  <form id="select" method="post" action="gabfunc2grauadm.php?q=4">
            <br>
        <div>
...
<Br><br>
  ...
  <form id="select" method="post" action="gabfunc2grauadm.php?q=5">
            <br>
        <div>
