...
<header>
      ...
      <nav class="nav-collapse">
        <ul>
          ...
          <li class="menu-item"><a href="menu/trocasenha.php" data-scroll>Trocar Senha</a></li>
  ...
  <h2>Matemática</h2>
        ...
        <br>
          ...
          <font face="Arial"><font size="4" color="black">Veja abaixo os conteúdos mais<br> cobrados no ENEM:<br><br>
            <button class="button button1" onclick="window.location.href='./pratmadm.php'"><div style="text-decoration: none;"><font color="white">Progressão Aritmética</button></font></div><br>
            <button class="button button1" onclick="window.location.href='./progeoadm.php'"><div style="text-decoration: none;"><font color="white">Progressão Geométrica</font></div></button><br><br>
            <button class="button button1" onclick="window.location.href='./func1grauadm.php'"><div style="text-decoration: none;"><font color="white">Função do 1º grau</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./func2grauadm.php'"><div style="text-decoration: none;"><font color="white">Função do 2º grau</font></div></button><br><br>
<button class="button button1" onclick="window.location.href='./analcombadm.php'"><div style="text-decoration: none;"><font color="white">Análise Combinatória</button></font></div><br><br></font></font>
</div>
</div>
</ul>
