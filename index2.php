  ...
  <header>
      ...
      <nav class="nav-collapse">
        <ul class="nav">
          ...
          <li class="menu-item"><a href="menu/enem.php" data-scroll>ENEM</a></li>
...
<div class="alerta atencao">Estudante: <?php echo $_SESSION["nome"];  ?> </font></div>
<br>
    ...
    <ul class="s-content">
      ...
      <li class="s-item s-item-5"></li>
       ...
       <div style="text-align:center;justify-content:center;" align="center">
          <font face="Anson"><font size="5" color="black">Olá, <?php echo $_SESSION["nome"];  ?>. Seja muito bem vindo ao portal Sem Dúvidas!<br>Agora que você está logado, entre no menu de matérias e comece a estudar. Desejamos bons estudos para você! 
 </font>
</font>
 </div>
...
<br><br>
    ...
    <div align="left">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="menu/materias.php"><img src="imagens/redacao.png" class="responsive2"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="imagens/std.png" class="responsive3">
      </div>
